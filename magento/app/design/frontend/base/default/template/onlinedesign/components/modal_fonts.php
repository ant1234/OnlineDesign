        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="nbdesigner_art_modal_header">
                    <span><?php echo $this->__("Fonts") ?></span>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropup  shadow hover-shadow">
                            <li ><a ng-click="loadGoogleFont()"><?php echo $this->__("Google Font") ?></a></li>
            ...
            <div class="modal-body">
                ...
                <div>
                    <button ng-show="(countFont > 10) && (countFont > fontPageSize)" style="margin-right: 15px; margin-top: 10px;" id="font-load-more" type="button" class="btn btn-primary shadow nbdesigner_upload" ng-click="changeFontPageSize(false)"><?php echo $this->__("More") ?></button>
