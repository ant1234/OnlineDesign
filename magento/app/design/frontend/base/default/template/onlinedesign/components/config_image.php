...
<div id="config_image" class="shadow od_tab nbdesigner_config" ng-style="{'display': pop.art}">
    ...
    <div id="image_general" class="content">
        ...
        <div class="nb-col-8">
            ...
            <div>
                <span ng-show="settings['nbdesigner_image_crop'] == 1" class="text-update btn btn-default btn-xs fa fa-crop" data-target="#dg-crop-image" data-toggle="modal" title="<?php echo $this->__("Crop Image") ?>" ng-click="initCropCanvas('crop')">&nbsp;<?php echo $this->__("Crop Image") ?></span>  
                <span ng-show="settings['nbdesigner_image_shapecrop'] == 1" class="text-update btn btn-default btn-xs fa fa-star" data-target="#dg-crop-image" data-toggle="modal" title="<?php echo $this->__("Shape Image") ?>" ng-click="initCropCanvas('shape')">&nbsp;<?php echo $this->__("Shape Image") ?></span>  
