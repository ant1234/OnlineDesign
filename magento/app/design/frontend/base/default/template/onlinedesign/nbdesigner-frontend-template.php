...
<html lang="<?php echo get_bloginfo('language'); ?>" ng-app="app">
    <head>
        ...
        <script type="text/javascript">
            var NBDESIGNCONFIG = {
                ...
                is_mobile   :   "<?php echo 0; //wp_is_mobile(); ?>",
                ...
                is_designer :  <?php /*if(current_user_can('edit_nbd_template')) */ echo 1; ?>,
                ...
                ajax_url    : "<?php echo $this->getUrl('onlinedesign/index/nbdesigner_get_product_info', array('_current'=>true)); ?>",
    ...
    <body ng-controller="DesignerController" >
        ...
        <div class="od_processing">
            ...
            <p id="first_message"><?php echo $this->__("NBDESIGNER PROCESSING...") ?></p>
