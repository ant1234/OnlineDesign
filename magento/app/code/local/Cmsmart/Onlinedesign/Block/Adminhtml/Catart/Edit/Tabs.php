...
class Cmsmart_Onlinedesign_Block_Adminhtml_Catart_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
      $this->addTab('form_section', array(
          ...
          'content'   => $this->getLayout()->createBlock('onlinedesign/adminhtml_catart_edit_tab_form')->toHtml(),
      ));
